...
Ensure you have a basic understanding of statistics and regex as listed in [pre-classs](./pre-class.md).
...
We will be using the `notebooks/eda_basic.ipynb` notebook throughout this lesson.
